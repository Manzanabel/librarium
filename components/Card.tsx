...
export default function Card({ title, authors, year, cover }: CardProps) {
  ...
  return (
    <div className="w-full max-w-96 p-4 justify-items-center border border-0 rounded-lg shadow-md bg-gradient-to-r hover:from-pink-500/25 hover:to-violet-500/25">
